window.addEventListener("load", function(){
	...
	*/
	...
	let resetDelay=document.getElementById("resetDelay");
	resetDelay.onclick=function resetDelay(){
	...
	rescos.onclick = function resetCos(){
	cos.innerHTML="Cos de cumparaturi:";
	total=0;
	tot.innerHTML="0lei";
}
	cos.innerHTML=localStorage.getItem("cos");
	tot.innerHTML=localStorage.getItem("tot");
});
...
save=setInterval(function save(){
	localStorage.setItem("cos",cos.innerHTML);
	localStorage.setItem("tot",tot.innerHTML);
},1000*5)
